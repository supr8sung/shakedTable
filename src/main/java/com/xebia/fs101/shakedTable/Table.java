package com.xebia.fs101.shakedTable;

import com.xebia.fs101.shakedTable.layout_manager.LayoutTemplate;
import com.xebia.fs101.shakedTable.layout_manager.TableLayout;
import com.xebia.fs101.shakedTable.layout_manager.TableLayoutFactory;
import com.xebia.fs101.shakedTable.renderer.ConsoleBaseRenderer;
import com.xebia.fs101.shakedTable.renderer.Renderer;

import java.util.ArrayList;
import java.util.List;

import static com.xebia.fs101.shakedTable.layout_manager.TableLayout.HORIZONTAL;
    ...
    public static final class Builder {
        ...
        public Builder withLayoutOption(TableLayout tableLayout) {
            if (columnWidth != null && columnWidth.length > 0)
                layoutTemplate = TableLayoutFactory.getLayoutManager(tableLayout,
                        rowCount, colCount, columnWidth);
            else
                layoutTemplate = TableLayoutFactory.getLayoutManager(tableLayout,
                        rowCount, colCount);
            return this;
